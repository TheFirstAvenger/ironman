defmodule Ironman.Checks.SimpleDepTest do
  ...
  alias Ironman.Test.Helpers.{MixBuilder, Utils}
  ...
  describe "up to date" do
    test "does nothing when dep is up to date" do
      ...
      Utils.set_dep_http(:ex_doc, "1.2.3")
  ...
  describe "out of date" do
    test "updates when y pressed" do
      Utils.set_dep_http(:ex_doc, "1.2.3")
      Utils.set_io("Upgrade ex_doc from ~> 1.2.2 to 1.2.3?\n", "y")
    ...
    test "multiple" do
      Utils.set_dep_http(:ex_doc, "1.2.3")
      Utils.set_io("Upgrade ex_doc from ~> 1.2.2 to 1.2.3?\n", "y")
      Utils.set_dep_http(:earmark, "2.3.6")
      Utils.set_io("Upgrade earmark from ~> 2.3.4 to 2.3.6?\n", "y")
  ...
  describe "missing" do
    test "updates when y pressed" do
      Utils.set_dep_http(:ex_doc, "1.2.3")
      Utils.set_io("Install ex_doc 1.2.3?\n", "y")
    ...
    test "multiple" do
      ...
      Utils.set_io("Install ex_doc 1.2.3?\n", "y")
      Utils.set_dep_http(:earmark, "2.3.6")
      Utils.set_io("Install earmark 2.3.6?\n", "y")
